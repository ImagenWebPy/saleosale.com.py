...
include $_SERVER['DOCUMENT_ROOT'] . '/libs/Session.php';
//cargamos el carrito y lo inicializamos
require $_SERVER['DOCUMENT_ROOT'] . '/util/Carrito.php';
Session::init();
$url_temporal = 'http://saleosale.imagenwebhq.com/';
?>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                                <tr>
                                                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                                                        <a href="<?php echo URL; ?>"><img width="220" src="<?php echo $url_temporal; ?>public/images/logo.png" alt="logo" /></a>
                                                    </td>
                ...
                <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                    <center>
                        <table cellspacing="0" cellpadding="0" width="600" class="w320">
                            ...
                            <tr>
                                <td class="free-text">
                                    Hola <?php echo $_SESSION['cliente']['nombre'] . ' ' . $_SESSION['cliente']['apellido']; ?>, hemos recibido su pedido.
                                </td>
                            </tr>
                            <tr>
                                <td class="button">
                                    <div><!--[if mso]>
                                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://saleosale.com.py/cliente/dashboard/" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                                        <w:anchorlock/>
                                        <center style="color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;">My Account</center>
                                      </v:roundrect>
                                    <![endif]--><a href="http://saleosale.com.py/cliente/dashboard/"
                                                       style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Mi Panel</a></div>
                                </td>
                            </tr>
                            <tr>
                                <td class="w320">
                                                    ...
                                                    <tr>
                                                        <td class="mini-block-padding">
                                                            <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                                                <tr>
                                                                    <td class="mini-block">
                                                                        <span class="header-sm">Dirección de envío</span><br />
                                                                        Jane Doe <br />
                                                                        123 Street <br />
                                                                        Victoria, BC <br />
                                                                        Canada
